...
const cssSelectorBuilder = {
  ...
  createSelector(elem) {
    const obj = { ...this };
    obj[elem] = () => { throw new Error('Element, id and pseudo-element should not occur more then one time inside the selector" if element, id or pseudo-element occurs twice or more times'); };
    this.result = '';
    this.number = 0;
    return obj;
  },
